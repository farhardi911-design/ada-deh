...
const questions = [
  {
    question: "Apa hal yang sangat disukai temanmu?",
    type: "choice",
    answers: ["Tukang tidur", "Main game", "Jalan-jalan", "Nonton film"],
    correct: "Tukang tidur"
  },
  {
    question: "Apa hobi temanmu?",
    type: "choice",
    answers: ["Baca Manhwa", "Main game", "Mancing", "Olahraga"],
    correct: "Baca Manhwa"
  },
  {
    question: "Gimana sifat temanmu?",
    type: "choice",
    answers: ["Baik", "Tengil", "Sering bercanda", "Pendiam"],
    correct: "Sering bercanda"
  },
  {
  ...
  {
    question: "Kapan tanggal lahir temanmu?",
    type: "choice",
    answers: [
      "16 Maret 2010",
      "16 April 2010",
...
function showResult() {
  ...
  if (score === 0) {
    ...
    resultText.textContent =
      `Skor kamu ${score}/4. Gila, kamu hafal banget sama temanmu!`;
    ...
    resultText.textContent =
      `Skor kamu ${score}/4. Lumayan, masih kenal dong!`;
    ...
    resultText.textContent =
      `Skor kamu ${score}/4. Kayaknya harus lebih sering ngobrol nih 😹`;
